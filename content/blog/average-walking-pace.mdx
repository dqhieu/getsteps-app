...
For context, a 6-foot man has a natural stride of about 2.6 feet, while a 5'4" woman averages closer to 2.2 feet. Same cadence (steps per minute), different distance covered. If you want to see how your height translates into steps per mile, our [Steps Per Mile Calculator](/tools/steps-per-mile-calculator) does the math for you.
