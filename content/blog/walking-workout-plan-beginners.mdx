...
This interval structure burns approximately 20–30% more calories than a steady-pace walk of the same duration, according to research published in the *Journal of Obesity*. For a simpler, research-backed interval template, try the [Japanese interval walking method](/blog/japanese-interval-walking-method) — 3 minutes fast, 3 minutes easy, repeated five times. Want to know exactly how many steps you cover? See our breakdown of [how many steps in 30 minutes of walking](/blog/how-many-steps-in-30-minutes-walking).
...
- **Add load** — Try [walking with a weighted vest](/blog/walking-with-weighted-vest) to raise calorie burn and bone-loading stimulus without picking up the pace
