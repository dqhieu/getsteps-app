...
keyword: "export gpx apple watch"
---

# How to Export GPX from Apple Watch Workouts: Complete Guide 2026

<TLDR>
Apple's native Workout app does not export GPX directly. The simplest path is to record a workout in **Steps: Workout & Pedometer**, open the workout on iPhone, and tap **Export GPX** — supports walking, running, hiking, and cycling. For old Apple Workout routes, a third-party Health extractor is still required.
</TLDR>
