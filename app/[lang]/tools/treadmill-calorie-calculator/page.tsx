...
import { loadTreadmillCalorieCalculatorMessages } from "@/lib/i18n/messages/tool-pages/treadmill-calorie-calculator";
...
export async function generateMetadata({ params }: LangPageProps): Promise<Metadata> {
  ...
  const t = await loadTreadmillCalorieCalculatorMessages(locale);
...
export default async function TreadmillCalorieCalculatorPage({ params }: LangPageProps) {
  const locale = await getLocale(params);
  const t = await loadTreadmillCalorieCalculatorMessages(locale);
