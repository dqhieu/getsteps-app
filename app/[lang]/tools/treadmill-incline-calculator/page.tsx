...
import { loadTreadmillInclineCalculatorMessages } from "@/lib/i18n/messages/tool-pages/treadmill-incline-calculator";
...
export async function generateMetadata({ params }: LangPageProps): Promise<Metadata> {
  ...
  const t = await loadTreadmillInclineCalculatorMessages(locale);
...
export default async function TreadmillInclineCalculatorPage({ params }: LangPageProps) {
  const locale = await getLocale(params);
  const t = await loadTreadmillInclineCalculatorMessages(locale);
